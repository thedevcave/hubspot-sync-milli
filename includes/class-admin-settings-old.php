...
class HubSpot_Sync_Milli_Admin_Settings {
    ...
    private function render_contact_sync_tab() {
        ...
        <table class="widefat striped">
            ...
            <tbody>
                <tr>
                    <td><strong><?php esc_html_e( 'State', 'hubspot-sync-milli' ); ?></strong></td>
                    <td>
                        <input type="text" 
                               name="hubspot_sync_milli_settings[contact_field_mapping][state]" 
                               value="<?php echo esc_attr( $this->settings['contact_field_mapping']['state'] ?? 'state' ); ?>" 
                               placeholder="state" 
                               class="regular-text" />
                    </td>
                    <td><?php esc_html_e( 'Customer state from checkout field', 'hubspot-sync-milli' ); ?></td>
                </tr>
                <tr>
                    <td><strong><?php esc_html_e( 'Country', 'hubspot-sync-milli' ); ?></strong></td>
                    <td>
                        <input type="text" 
                               name="hubspot_sync_milli_settings[contact_field_mapping][country]" 
                               value="<?php echo esc_attr( $this->settings['contact_field_mapping']['country'] ?? 'country' ); ?>" 
                               placeholder="country" 
                               class="regular-text" />
                    </td>
                    <td><?php esc_html_e( 'Customer country from checkout field', 'hubspot-sync-milli' ); ?></td>
                </tr>
            </tbody>
        </table>
        <?php
    ...
    private function render_deal_sync_tab() {
        ...
        <table class="form-table">
            <tr>
                <th scope="row">
                    <label for="owner_id"><?php esc_html_e( 'Deal Owner ID', 'hubspot-sync-milli' ); ?></label>
                </th>
                <td>
                    <input type="text" 
                           id="owner_id" 
                           ...
                           class="regular-text" />
                    <p class="description"><?php esc_html_e( 'HubSpot user ID to assign as deal owner.', 'hubspot-sync-milli' ); ?></p>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" 
                           ...
                           class="regular-text" />
                    <p class="description"><?php esc_html_e( 'Pipeline ID for new deals.', 'hubspot-sync-milli' ); ?></p>
                </td>
            </tr>
        </table>
        ...
        <table class="widefat striped">
            <thead>
                <tr>
                    <th><?php esc_html_e( 'Order Status', 'hubspot-sync-milli' ); ?></th>
                    <th><?php esc_html_e( 'HubSpot Deal Stage ID', 'hubspot-sync-milli' ); ?></th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td><strong><?php esc_html_e( 'Processing', 'hubspot-sync-milli' ); ?></strong></td>
                    <td>
                        <input type="text" 
                               name="hubspot_sync_milli_settings[deal_stages][processing]" 
                               value="<?php echo esc_attr( $this->settings['deal_stages']['processing'] ?? '' ); ?>" 
                               class="regular-text" />
                    </td>
                </tr>
                <tr>
                    <td><strong><?php esc_html_e( 'Completed', 'hubspot-sync-milli' ); ?></strong></td>
                    <td>
                        <input type="text" 
                               name="hubspot_sync_milli_settings[deal_stages][completed]" 
                               value="<?php echo esc_attr( $this->settings['deal_stages']['completed'] ?? '' ); ?>" 
                               class="regular-text" />
                    </td>
                </tr>
            </tbody>
    ...
    private function render_advanced_tab() {
        ...
        <h3><?php esc_html_e( 'Association IDs', 'hubspot-sync-milli' ); ?></h3>
        <p><?php esc_html_e( 'Configure custom association IDs for linking contacts and deals.', 'hubspot-sync-milli' ); ?></p>
        
        <table class="widefat striped">
            <thead>
                <tr>
                    <th><?php esc_html_e( 'Association Type', 'hubspot-sync-milli' ); ?></th>
                    <th><?php esc_html_e( 'Association ID', 'hubspot-sync-milli' ); ?></th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td><strong><?php esc_html_e( 'Contact to Deal', 'hubspot-sync-milli' ); ?></strong></td>
                    <td>
                        <input type="text" 
                               name="hubspot_sync_milli_settings[association_ids][contact_to_deal]" 
                               value="<?php echo esc_attr( $this->settings['association_ids']['contact_to_deal'] ?? '' ); ?>" 
                               class="regular-text" />
                    </td>
                </tr>
            </tbody>
        ...
        <?php
                ...
                <div id="general" class="tab-content active">
                    <h2><?php esc_html_e( 'General Settings', 'hubspot-sync-milli' ); ?></h2>
                    <p><?php esc_html_e( 'Configure your HubSpot API connection and basic settings.', 'hubspot-sync-milli' ); ?></p>
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            <th scope="row">
                                <label for="owner_id"><?php esc_html_e( 'Default HubSpot Owner ID', 'hubspot-sync-milli' ); ?></label>
                            </th>
                            <td>
                                <input type="text" 
                                       id="owner_id" 
                ...
                <!-- Contact Sync Tab -->
                <div id="contact-sync" class="tab-content">
                    <h2><?php esc_html_e( 'Contact Sync Settings', 'hubspot-sync-milli' ); ?></h2>
                    <p><?php esc_html_e( 'Configure how custom checkout fields are synced to HubSpot contact properties.', 'hubspot-sync-milli' ); ?></p>
                ...
                <!-- Deal Sync Tab -->
                <div id="deal-sync" class="tab-content">
                    <h2><?php esc_html_e( 'Deal Sync Settings', 'hubspot-sync-milli' ); ?></h2>
                    <p><?php esc_html_e( 'Configure how WooCommerce orders are synced to HubSpot deals.', 'hubspot-sync-milli' ); ?></p>
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            <th scope="row">
                                <label for="deal_pipeline"><?php esc_html_e( 'Deal Pipeline', 'hubspot-sync-milli' ); ?></label>
                            </th>
                            <td>
                                <input type="text" 
                                       id="deal_pipeline" 
                    ...
                    <h3><?php esc_html_e( 'Deal Stages', 'hubspot-sync-milli' ); ?></h3>
                    <p><?php esc_html_e( 'Map WooCommerce order statuses to HubSpot deal stages.', 'hubspot-sync-milli' ); ?></p>
                ...
                <div id="advanced" class="tab-content">
                    <h2><?php esc_html_e( 'Advanced Settings', 'hubspot-sync-milli' ); ?></h2>
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Debug Logging', 'hubspot-sync-milli' ); ?></th>
                            <td>
                                <label>
                                    <input type="checkbox" 
                                           name="hubspot_sync_milli_settings[debug_logging]" 
